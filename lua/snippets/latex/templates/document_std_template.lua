...
local document_template_tab  = {
	...
	,
	% Fonts and layout,
	\\usepackage[activate={true,nocompatibility},final,tracking=true,kerning=true,spacing=true,factor=1100,stretch=10,shrink=10]{microtype} %  typesetting improvements, settings by Siarhei Khirevich, see http://www.khirevich.com/latex/microtype/,
	\\microtypecontext{spacing=nonfrench},
	%\\usepackage[bottom=2.5cm]{geometry},
	\\usepackage[top=3cm,bottom=1cm,hmargin=2cm]{geometry} % not needed if the typearea style in Koma-Script is used,
	...
	%\\RedeclareSectionCommand[tocnumwidth=7mm]{section} % page number alignment in table of contents,
	%\\RedeclareSectionCommand[tocnumwidth=10mm]{subsection} % page number alignment in table of contents,
	...
	,
	 % Hyperlinks,
	\\usepackage[linktoc=page,colorlinks=true,linkcolor=Blue,citecolor=DarkGreen,urlcolor=DarkTurquoise]{hyperref},
	,
	...
	,
	\\title{$1},
	\\date{Winter Term 2021/2022, Version of November 20th, 2021},
	\\author{},
	,
	\\begin{document},
	,
